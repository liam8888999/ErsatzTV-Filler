...
ffmpeg -y -i $workdir/weather-v1.mp4 -vf "fade=t=out:st=10:d=5" -c:a copy $output/weather-v1.mp4
...
ffmpeg -y -i $workdir/weather-v2.mp4 -vf "fade=t=out:st=10:d=5" -c:a copy $output/weather-v2.mp4
...
ffmpeg -y -i $workdir/weather-v3.mp4 -vf "fade=t=out:st=10:d=5" -c:a copy $output/weather-v3.mp4
