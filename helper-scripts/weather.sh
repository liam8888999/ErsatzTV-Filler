...
then
  ...
  ffmpeg -y -i "concat:$workdir/weatherv4-v1.mp4|$workdir/weatherv4-v2.mp4|$workdir/weatherv4-v3.mp4" -i "$audio3" -shortest -pix_fmt yuv420p -c:a copy $workdir/weather-v4.mp4
