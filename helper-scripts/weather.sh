...
ffmpeg -y -i $workdir/weather-v1.mp4 -vf "fade=t=out:st=10:d=5" -af "afade=t=out:st=5:d=5" $output/weather-v1.mp4
...
ffmpeg -y -i $workdir/weather-v2.mp4 -vf "fade=t=out:st=10:d=5" -af "afade=t=out:st=5:d=5" $output/weather-v2.mp4
...
ffmpeg -y -i $workdir/weather-v3.mp4 -vf "fade=t=out:st=10:d=5" -af "afade=t=out:st=5:d=5" copy $output/weather-v3.mp4
