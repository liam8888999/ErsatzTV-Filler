  ...
  app.post('/themecreator', (req, res) => {
    ...
    const updatedThemeData = {
        ...
        "Weather": {
            ...
            "weatherimagebackgroundcolour": stripHash(req.body.weatherimageBackgroundColour),
            "weatherimagetextcolour": stripHash(req.body.weatherimagetextColour)
        },
        "ChannelLogo": {
 ...
 const discordMessage = {
     ...
     embeds: [
        ...
        const options = {
            ...
            port: 443,
            path: '/api/webhooks/1387838288005566514/V_efa5pr_lcQflXaHNbMsaH0j-gv3bkkiNtTmoubm0jmlRJOyT2DCcvQVuN0I1fMAgbJ', // Replace with your webhook ID and token
            method: 'POST',
     headers: {
